...
//   if (!user) {
//     return <p className="text-center py-10 text-neutral-500">Loading...</p>;
//   }
...
//           {/* Mini user card - ẩn trên mobile để tiết kiệm chỗ */}
...
//                 className={`flex items-center gap-2 px-3 py-2.5 rounded-lg text-sm text-left whitespace-nowrap transition-colors ${
//                   activeTab === t.key
